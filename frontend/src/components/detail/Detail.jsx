...
<div className=" block overflow-y-auto  h-[calc(30vh-4rem)]">
      ...
      <button className=" bg-white text-black px-10 py-1 rounded-xl hover:bg-red-600 duration-300 ease-in-out hover:text-white">Block User</button>
      </div>
      <div className=" flex items-center mt-4 justify-center  ">

      <button className=" bg-blue-600 text-black px-10 py-1 rounded-xl hover:bg-blue-800 duration-300 ease-in-out hover:text-white">Logout</button>
      </div>
