...
const ChatList = () => {
  ...
  <input type="text" placeholder="Search.." className="p-2 rounded-xl bg-transparent border-none focus:outline-none" />
        ...
        <div className=" p-2">
        <img src={ addMode ? "/minus.png" :"/plus.png"} onClick={()=> setAddMode(!addMode)} className={`h-6 w-6 ${addMode ? "rotate-180" : "rotate-0"} bg-[rgba(17,25,40,0.5)] p-1 rounded-full transition transform `}  alt="plus" height={10} width={10} />
        </div>
        </div>
        ...
        <div className=" flex items-center space-x-4 border-b-2 border-[#dddddd35]  ">
            ...
            <img src="avatar.png" alt="avatar" className="h-16 w-16 rounded-full p-1 " height={10} width={10} />
            </div>
            <div>
        <h1>Ayan</h1>
